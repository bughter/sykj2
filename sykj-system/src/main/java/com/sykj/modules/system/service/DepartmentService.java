...
public interface DepartmentService {
    ...
    */
    Map<String,Object> queryAll(DepartmentQueryCriteria criteria, Pageable pageable);
    ...
    */
    List<DepartmentDto> queryAll(DepartmentQueryCriteria criteria);

    Map<String,Object> getDepts(DepartmentQueryCriteria criteria, Pageable pageable);
    ...
    * @return DepartmentDto
    */
    DepartmentDto create(Department resources);
